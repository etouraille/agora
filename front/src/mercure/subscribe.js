...
import {set as setReadyForVote, setNullReadyForVoteAndRound} from './../redux/slice/readyForVoteSlice';
    ...
    onMessage(me) {
        ...
        return (data) => {
            ...
            if (message.subject === 'documentUnTouched') {
                ...
                store.dispatch( setNullReadyForVoteAndRound({id, round: message.currentRound}));
            }
        }
    }
